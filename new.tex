...
\title{MoViMash: Online Mobile Video Mashup} %\titlenote{(Produces the permission block, and
...
% 1st. author
%\alignauthor
Shailendra Kumar Gupta\\%\titlenote{Dr.~Trovato insisted his name be first.}\\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{IIT Ropar}\\
       \email{2016csb1059@iitrpr.ac.in}
% 2nd. author
\alignauthor
Abhinav Jindal \\%\titlenote{The secretary disavows
% knowledge of this author's actions.}\\
       \affaddr{Dept. of ECE}\\
       \affaddr{IIT Ropar}\\
       %\affaddr{Dublin, Ohio 43017-6221}\\
       \email{2016csb1026@iitrpr.ac.in}
\and
% 3rd. author
\alignauthor Batchu Meghana \\%\titlenote{This author is the
%one who did all the really hard work.}\\
       \affaddr{Dept. of ECE}\\
       \affaddr{IIT Ropar}\\
     %  \affaddr{Hekla, Iceland}\\
       \email{2016csb1034@iitrpr.ac.in}
...
\alignauthor Mamatha\\
       ...
       \email{2014csb10XX@iitrpr.ac.in}
}
...
\maketitle
\begin{abstract}
this is change made in abstract section.
...
I user 2 introducing some chages in the new.tex file of our project in remote repository.
...
to calculate the final score %\textit{S^0}:
...
this is change made in diversity sub section.
...
\centering
\caption{A Comparison of Previous Work}
\begin{tabular*}{\columnwidth}{c{1cm}|c{1cm}|c{1cm}|c{1cm}|c{1cm}|c{1cm}} \hline
Performance&Type&Recordings&Duration(m)&Frame rate&Resolution\\ \hline
\texttt P1&Group Dance&12&4'&30&720*480  \\ \hline
\texttt P2&Group Dance&12&3'50"&30&720*480  \\ \hline
\texttt P3&Solo Singing&5&2'5"&25&640*480  \\ \hline
\end{tabular*}
\end{table}
